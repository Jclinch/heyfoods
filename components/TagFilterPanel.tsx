...
//     onFilterChange(updatedTags); // 🔥 sends tag names now
//   };
  
//   // Removed misplaced lines as they are redundant and improperly placed
...
//           className={`cursor-pointer text-center min-w-[130px] ml-[50px] transition-all duration-300 ease-in-out p-2 rounded-md flex flex-col items-center justify-center
//             ${selectedTags.includes(tag.id) ? "bg-gray-200 text-black font-bold border border-gray-200" : "hover:bg-gray-100"}
//           `}
//         >
//           <Image
//             src={tag.iconPath}
...
//         <button
//           onClick={resetTags}
//           className="text-red-500 font-semibold ml-4 underline"
//         >
//           Reset
//         </button>
//       )}
